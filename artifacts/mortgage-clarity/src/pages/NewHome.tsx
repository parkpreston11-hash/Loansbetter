        ...
        <motion.div {...fadeUp(0)} className="bg-secondary/40 border border-border rounded-3xl p-8 md:p-12 max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: CreditCard, title: "We work for you", desc: "LoansBetter is independent. We help you understand your options clearly — not steer you toward any particular product or lender." },
